...
export function WhatsAppButton({ phoneNumber, message }: WhatsAppButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-xs transition-all duration-500 ease-in-out font-headline font-bold text-sm group-hover:ml-3 group-hover:mr-1">
        Chat with us
      </span>
    </a>
  );
